  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
      <div className="flex items-center gap-2 mb-4">
        <h3 className="text-2xl font-bold text-white">⚠️ Hallucination Risk Assessment</h3>
      ...
      {hallucinationReport.factCheckSummary && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          <div className="bg-zinc-800 p-3 rounded">
            <div className="text-sm text-gray-400">Total Facts</div>
          ...
          <div className="bg-zinc-800 p-3 rounded">
            <div className="text-sm text-gray-400 mb-2">Context Risk</div>
            <div className="text-2xl font-bold text-white">
      ...
      {hallucinationReport.triggers && hallucinationReport.triggers.length > 0 && (
        <div>
          <div className="flex items-center gap-2">
            <strong className="text-gray-300">Risk Triggers:</strong>
            <button
              ...
              {hallucinationReport.triggers
                ...
                .map((trigger, idx) => (
                  <div key={idx} className={`bg-zinc-800 p-4 rounded border-l-4 ${
                    ...
                    <div className="text-white mt-1">{trigger.description}</div>
